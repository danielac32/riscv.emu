...
extern struct	procent *active_task;
#define	stdin	((proctab[active_task->pid]).prdesc[0])
#define	stdout	((proctab[active_task->pid]).prdesc[1])
#define	stderr	((proctab[active_task->pid]).prdesc[2])
